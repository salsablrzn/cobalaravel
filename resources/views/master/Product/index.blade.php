...
<label>Show<select name="example1_length" aria-controls="example1" class="custom-select custom-select-sm form-control form-control-sm"><option value="10">10</option><option value="25">25</option><option value="50">50</option><option value="100">100</option></select></label>
    ...
    <div class="col-sm-6">
            &nbsp;
            <a href="../ProductCreate" class="btn btn-success" ><i class="material-icons"></i> <span>Add New Product</span></a>    
          </div>
    <br>
                  ...
                  <thead>                  
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>15 pack</td>
                        <td>Rasa coklat</td>
                        <td class="btn btn-info" style="padding: 5px"><a href="ProductEdit"style="color: white;">Edit</td>
                        <td class="btn btn-danger" type="submit" style="padding: 5px"><a href="ProductDestroy" style="color: white;">Delete</td>
                      </tr>
                      ...
                      <tr>
                        ...
                        @endif
                      <td class="btn btn-info" style="padding: 5px"><a href="ProductEdit{{ $PRO -> Product_ID }}"style="color: white;">Edit</td>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a href="ProductDestroy/{{ $PRO -> Product_ID }}"><button type="submit" class="btn btn-danger">Yakin</button></a>    
        </div>
      </div>
