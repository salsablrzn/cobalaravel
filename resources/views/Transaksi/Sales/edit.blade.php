...
<!-- form start -->
              <form role="form">
                ...
                <div class="card-footer">
                	<button type="submit" class="btn btn-primary"><a href="SalesIndex" style="color: white;">Cancel</button>
                	<button type="submit" class="btn btn-primary"><a href="SalesIndex" style="color: white;">Update Data</button>
