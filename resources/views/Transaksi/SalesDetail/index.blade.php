...
<label>Show<select name="example1_length" aria-controls="example1" class="custom-select custom-select-sm form-control form-control-sm"><option value="10">10</option><option value="25">25</option><option value="50">50</option><option value="100">100</option></select></label>
    ...
    <div class="col-sm-6">
            &nbsp;
            <a href="../PosCreate" class="btn btn-success" ><i class="material-icons"></i> <span>Add New Detail Sales</span></a>     
          </div>
    <br>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Tabel Sales Detail</h3>
                ...
                <table class="table table-hover text-nowrap">
                  <thead> 
                    ...
                    <tbody>
                      ...
                      @foreach($sales_detail as $DET)
                      <tr>
                        <th scope="row">{{ $loop->iteration }}</th>
                        <td>{{ $DET -> Nota_ID }}</td>
                        <td>{{ $DET -> Product_ID }}</td>
                        <td>{{ $DET -> Quantity }}</td>
                        <td>{{ $DET -> Selling_Price }}</td>
                        <td>{{ $DET -> Discount }}</td>
                        <td>{{ $DET -> Total_Price }}</td>
                        <td class="btn btn-info" type="submit" style="padding: 5px"><a href="PosInvoice{{$DET->Nota_ID}}" style="color: white;">Invoice</td>
                      </tr>
                      @endforeach
