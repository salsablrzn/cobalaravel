...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="asset/AdminLTE-3.0.2/index3.html" class="nav-link">Home</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="asset/AdminLTE-3.0.2/index3.html" class="brand-link">
              ...
              <form role="form">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input class="form-control" id="exampleInputNama" type="nama" placeholder="Enter Nama">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" id="exampleInputNoTelp" type="Telp" placeholder="Enter No Telp">
                  </div>
                ...
                <div class="input-group">
                  ...
                  <div class="Jenis Kelamin">
                    ...
                    <input type="radio" class="Jenis Kelamin" id="male" name="JK">
                    <label class="Jenis Kelamin" for="exampleInputJK">Pria</label>
                    <input type="radio" class="Jenis Kelamin" id="female" name="JK">
                    <label class="Jenis Kelamin" for="exampleInputJK">Wanita</label>
                  </div>
                </div>
                <!-- /.card-body -->
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2014-2019 <a href="asset/AdminLTE-3.0.2/https://adminlte.io">AdminLTE.io</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
